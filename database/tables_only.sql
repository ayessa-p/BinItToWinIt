-- MTICS Database Tables Only
-- Use this if the database 'binittowinit' already exists
-- Manila Technician Institute Computer Society

USE binittowinit;

-- Add is_admin field to users table (if not exists)
SET @dbname = DATABASE();
SET @tablename = "users";
...
-- Events table for admin management
